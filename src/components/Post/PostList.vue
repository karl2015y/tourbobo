            ...
            <div class="hidden sm:!block w-full sm:w-[30%]  ">
                <template v-for="category in postCategory">
                    <div
                        ...
                        class="cursor-pointer text-[#005A72] bg-white w-full py-[1.065rem] pl-4 text-3xl font-semibold rounded-lg shadow-[0px_0px_5px_rgba(0,0,0,0.25)]"
                    >
                        {{ category }}
                    </div>
                    <q-slide-transition>
                        ...
                        >
                            ...
                            <template v-for="post in PostArrayFilterByCategory">
                                ...
                                >
                                    ...
                                    <div class="w-full ml-2 text-[22px] line-clamp-2">{{ post.title }}</div>
                                </div>
                            </template>
                        </div>
                    </q-slide-transition>
